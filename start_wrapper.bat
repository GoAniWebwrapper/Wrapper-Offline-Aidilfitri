...
:: Restore info
:infomissing
echo Wrapper information is missing for some reason?
echo Restoring...
goto infocopy
:returnfrominfocopy
...
:: Start Node.js and http-server (VFProxy not included because I'm pretty sure VoiceForge never wanted it to happen.) Damn this comment is long. Let's make it longer >:) sdfuhsufshduifhsuifhsduifhsduivhsduivh haha weed is funny! but is it really? Yes! drugs are the funniest! for example: weed crack cocaine pot ecstasy molly percocet meth! did you laugh? YOU BETTER HAVE LAUGHED OR I WILL FUCKING MURDER YOU AND YOU WILL BE DEAD!!!  RAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAHHH GRRRRRRRRRRRRRRRRRRRRRRRRRRRRRR. lol
